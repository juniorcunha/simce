SiMCE.functions = {
	...
	removeForm: function() {
		...
		// Obtem os dados selecionados do grid para exibir o formulário
		bootbox.confirm("Tem certeza que deseja remover a operação " + SiMCE.functions.data.nome + "?", function(result) {
				...
				SiMCE.ajaxRequest(
					...
					function( data, textStatus, jqXHR ) {
						...
						if ( data.success === true ) {
							...
							SiMCE.successMessage("Operação removida com sucesso!");
						}
		...
		SiMCE.ajaxRequest(
			...
			function( data, textStatus, jqXHR ) {
				...
				if ( data.success === true ) {
					...
					// Mensagem para o usuário
					SiMCE.successMessage("Operação cadastrada/atualizada com sucesso!");
