SiMCE.functions = {
	...
	removeForm: function() {
		...
		// Obtem os dados selecionados do grid para exibir o formulário
		bootbox.confirm("Tem certeza que deseja remover a unidade " + SiMCE.functions.data.nome + "?", function(result) {
				...
				SiMCE.ajaxRequest(
					...
					function( data, textStatus, jqXHR ) {
						...
						if ( data.success === true ) {
							...
							SiMCE.successMessage("Unidade removida com sucesso!");
						}
		...
		SiMCE.ajaxRequest(
			...
			function( data, textStatus, jqXHR ) {
				...
				if ( data.success === true ) {
					...
					// Mensagem para o usuário
					SiMCE.successMessage("Unidade cadastrada/atualizada com sucesso!");
