SiMCE.functions = {
	...
	removeForm: function() {
		...
		// Obtem os dados selecionados do grid para exibir o formulário
		bootbox.confirm("Tem certeza que deseja remover o cargo/perfil " + SiMCE.functions.data.nome + "?", function(result) {
				...
				SiMCE.ajaxRequest(
					...
					function( data, textStatus, jqXHR ) {
						...
						if ( data.success === true ) {
							...
							SiMCE.successMessage("Cargo/Perfil removido com sucesso!");
						}
		...
		SiMCE.ajaxRequest(
			...
			function( data, textStatus, jqXHR ) {
				...
				if ( data.success === true ) {
					...
					// Mensagem para o usuário
					SiMCE.successMessage("Cargo/Perfil cadastrado/atualizado com sucesso!");
